...
board.on("ready", function() {
    ...
    temp.on("change", function() {	
    	...
    	// Transform celsius to a range from 0 to 50000, imitating a black-object. - 
    	var colorValue = scale(celsius, 40, -5, 0, 40000);
		...
		for(i in colors) {
		    ...
		    newdist = Math.abs(colorValue - i); // distance from current key to value
		    if (newdist < dist) {
